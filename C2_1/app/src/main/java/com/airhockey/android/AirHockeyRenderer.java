...
public class AirHockeyRenderer implements Renderer {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        String vertexShaderSource = FileUtils
            .readFromRaw(context, R.raw.simple_vertex_shader);
        String fragmentShaderSource = FileUtils
            .readFromRaw(context, R.raw.simple_fragment_shader);
